        ...
        <div className='flex flex-col items-center justify-center text-center gap-y-4 bg-background/0'>
          <Container className='relative hidden lg:block overflow-hidden'>
            <button className='group relative grid overflow-hidden rounded-full px-2 py-1 shadow-[0_1000px_0_0_hsl(0_0%_15%)_inset] transition-colors duration-200 mx-auto'>
              ...
              <span className='backdrop absolute inset-[1px] rounded-full bg-background transition-colors duration-200 dark:group-hover:bg-neutral-800 group-hover:bg-neutral-200' />
              <span className='z-10 py-0.5 text-sm dark:text-neutral-100 text-slate-900 flex items-center'>
          ...
          <Container delay={0.15}>
            <h1 className='text-4xl md:text-4xl lg:text-7xl font-bold text-center !leading-tight max-w-4xl mx-auto'>
              Tingkatkan <span className=''>Diagnosa Gigi{' '}</span>
              dengan AI Cerdas
            </h1>
          </Container>
          <Container delay={0.2}>
            <p className='max-w-xl mx-auto mt-2 text-base lg:text-lg text-center text-muted-foreground'>
              Otomatisasi berbasis AI dan wawasan untuk memproses radiograf
              lebih efisien dan mendukung keputusan Anda.
            </p>
          </Container>
          <Container delay={0.25} className='z-20'>
            <div className='flex items-center justify-center mt-6 gap-x-4'>
              <Link to='/sign-in' className='flex items-center gap-2 group'>
                <Button size='lg'>
                  Get Started
