      ...
      <Container>
        <div className='flex flex-col items-center text-center max-w-2xl mx-auto'>
          <h2 className='text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6'>
            Diagnosa Gigi Berbasis AI <br /> jadi lebih{' '}
            <span className='font-subheading italic'>mudah</span>
          </h2>
          <p className='text-base md:text-lg text-center text-accent-foreground/80 mt-6'>
            Tingkatkan proses diagnosa gigi dengan teknologi AI. Deteksi kondisi lebih cepat, kelola data pasien dengan efisien, dan buat keputusan lebih cerdas dalam hitungan menit.
          </p>
        </div>
      </Container>
