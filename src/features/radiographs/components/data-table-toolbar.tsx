...
import { IconRotateClockwise, IconTrash, IconUpload } from '@tabler/icons-react'
...
export function DataTableToolbar({
  ...
  const { setOpen: setOpenDialog } = useRadiographs() // Changed from setOpenUpload to setOpen

  //   const { setOpenUpload } = useRadiographs()
  return (
      ...
      <div className='flex items-center space-x-2'>
        ...
        <div className='flex gap-2'>
          <Button
            ...
            variant='default'
            className='space-x-1'
            onClick={() => setOpenDialog('import')} // Changed from setOpenUpload to setOpen
          >
