// src/features/radiographs/components/DataTablePagination.tsx
import {
  ChevronLeftIcon,
  ChevronRightIcon,
  DoubleArrowLeftIcon,
...
export function DataTablePagination({
  ...
  return (
    <div className='lg:flex-row md:flex-row flex-wrap lg:gap-y-0 md:gap-y-0 gap-y-3 flex items-center justify-between px-2'>
